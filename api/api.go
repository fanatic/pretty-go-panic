...
var defaultPalette = stack.Palette{
	...
	SourceFile:             "</span>",
	FunctionStdLib:         `<span class="has-text-success" title="stdlib (private)">`,
	FunctionStdLibExported: `<span class="has-text-success has-text-weight-bold"> title="stdlib"`,
	FunctionMain:           `<span class="has-text-primary has-text-weight-bold" title="main">`,
	FunctionOther:          `<span class="has-text-danger" title="(private)">`,
